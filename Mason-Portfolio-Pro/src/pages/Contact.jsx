...
function Contact() {
  return (
    <motion.section
      ...
      className="max-w-3xl mx-auto text-center px-4 py-20"
    >
      ...
      <p className="text-gray-400 mb-8 text-lg">
        ...
        Whether it's for a full-time position, freelance project, or collaboration, I bring strong technical skills, a team-first mindset, and a passion for problem-solving.
      </p>
